...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{slike/erosion.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{slike/dilatacija.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{slike/otvaranje_zatvaranje.png}
